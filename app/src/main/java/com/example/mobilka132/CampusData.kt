...
object CampusDatabase {
    ...
    init {
        addBuilding(
            0xFF2BD936.toInt(),
            BuildingInfo("Студенческий жилой комплекс «Маяк»", "улица Аркадия Иванова, 22, 24")
        )
        addBuilding(0xFF9FB824.toInt(), BuildingInfo("6 корпус ТГУ", "улица Аркадия Иванова, 49"))
        addBuilding(
            0xFF4C24BB.toInt(),
            BuildingInfo("Студенческий жилой комплекс «Парус»", "Буяновский переулок, 3а")
        )
        ...
        addBuilding(
            0xFFF74373.toInt(), BuildingInfo(
                "10 корпус ТГУ", "Проспект Ленина, 36, к10", listOf(
                    VenueInfo(
